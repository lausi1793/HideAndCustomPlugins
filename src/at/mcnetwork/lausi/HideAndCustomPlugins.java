...
public class HideAndCustomPlugins extends JavaPlugin implements Listener {
	...
	public void onEnable() {
		...
		this.plugins.addAll(Arrays.asList(getConfig().getString("plugins").split(", ")));
		getLogger().info("[" + name + "] Plugin has been activated successfully.");
	}

	public void onDisable() {
		saveDefaultConfig();
		getLogger().info("[" + name + "] Plugin was disabled successfully.");
	}
	...
	private void loadConfig() {
		...
		getLogger().info("[" + name + "] Successfully reloaded config.yml");
	}
